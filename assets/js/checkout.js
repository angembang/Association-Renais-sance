document.addEventListener("DOMContentLoaded", function () {
  ...
  amountInput.addEventListener("change", function (event) {
    ...
    const payload = {
      ...
      backUrl: "http://asso-renais-sance/index.php?route=home",
      errorUrl: "http://asso-renais-sance/index.php?route=error",
      returnUrl: "http://asso-renais-sance/index.php?route=donation-success",
